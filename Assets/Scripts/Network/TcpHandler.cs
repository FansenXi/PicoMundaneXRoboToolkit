...
namespace Robot
{
    public class TcpHandler : MonoBehaviour
    {
        ...
        public const int RECEIVE_TIME_OUT_DEFAULT = 1000;
        ...
        private int _sendTimeout = 1000; // timeout
        ...
        private void Connect()
        {
            ...
            try
            {
                ...
                lock (_sendObject)
                {
                    ...
                    // Note: TCP retransmission count is typically controlled by the operating system
                    // and cannot be directly set through Socket API in C#
                    // We've set the timeout to 1 second as requested
